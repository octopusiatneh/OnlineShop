namespace OnlineShop.Data.Migrations
{
    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Alisas = c.String(nullable: false, maxLength: 256),
        ...
        {
            DropForeignKey("dbo.ProducTags", "TagID", "dbo.Tags");
            DropForeignKey("dbo.ProducTags", "ProductID", "dbo.Products");
            ...
            DropIndex("dbo.ProducTags", new[] { "TagID" });
            DropIndex("dbo.ProducTags", new[] { "ProductID" });
